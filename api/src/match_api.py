...
class MatchCreate(BaseModel):
    ...
    duration_phase1: int = Field(
        ..., description="Duration of phase 1 in minutes", ge=1, le=120
    )
    duration_phase2: int = Field(
        ..., description="Duration of phase 2 in minutes", ge=1, le=120
    )
