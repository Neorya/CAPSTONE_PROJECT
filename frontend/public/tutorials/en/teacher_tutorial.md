...
When students are in the Lobby:
...
During the coding phase, you can:
...
* Encourage students to write strong test cases.
* Promote fair and constructive peer reviews.
* Use leaderboard results as learning feedback, not just competition.
