...
public class CreateGameSessionPO {
    ...
    private static final String SUCCESS_MESSAGE_XPATH = "//div[contains(@class,'ant-message')]//span[contains(text(),'created successfully')]";
    ...
    private static final String CALENDAR_OK_BUTTON_XPATH = "//button[contains(@class, 'ant-btn')]//span[text()='OK']/..";
